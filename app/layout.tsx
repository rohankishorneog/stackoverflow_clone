...
export const metadeta: Metadata ={
  title: "Devoverflow",
  description:"Your go-to platform for collaborative coding. Find quick answers, share insights, and connect with a global community of developers. Enhance your coding journey with real-time collaboration and a user-friendly interface. Join us today",
  icons:{
